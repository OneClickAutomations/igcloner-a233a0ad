...
import { Search, LayoutDashboard, Calendar as CalendarIcon, Settings as SettingsIcon, LogOut, FolderKanban, Send, Microscope } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const items = [
  ...
  { title: "Campaign Planner", url: "/calendar", icon: CalendarIcon },
